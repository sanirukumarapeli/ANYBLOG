...
export const addBlog = async (req, res) => {
  try {
    ...
    // optimize thourgh imageKit URL parameters
...
export const deleteBlogById = async (req, res) => {
  try {
    const { id } = req.body;
    const bloge = await Blog.findByIdAndDelete(id);
...
export const generateContent = async (req, res) => {
    try {
        ...
        const content = await main(prompt + ' Generate a blog post with proper formatting.');
