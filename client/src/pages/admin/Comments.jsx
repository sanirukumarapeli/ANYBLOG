...
function Comments() {
  ...
  return (
    <div className='flex-1 pt-5 px5 sm:pt-12 sm:pl-16 bg-blue-50/50'>
      ...
      <div className='relative h-4/5 max-w-3xl overflow-x-auto mt-4 bg-white shadow rounded-4xl scrollbar-hide'>
        <table className='w-full text-sm text-gray-500'>
          ...
          <tbody>
            {comments.filter((comment)=>{
              ...
              <CommentTableItems key={comment._id} comment={comment} fetchComments={fetchComments} />
            ))}
          </tbody>
        </table>
      </div>
